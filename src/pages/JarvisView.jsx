...
export default function JarvisView({ sidebarCollapsed }) {
  ...
  return (
    <div className={`h-[calc(100vh-6rem)] flex flex-col bg-zinc-900 text-zinc-100 overflow-hidden rounded-xl border border-zinc-800 shadow-2xl transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-0' : 'lg:ml-[280px]'}`}>
      {/* Header */}
      <div className="p-4 border-b border-zinc-800 flex justify-between items-center bg-zinc-900/50 backdrop-blur-sm">
        ...
        <span className="px-2 py-0.5 rounded-full bg-zinc-800 text-[10px] text-zinc-400 border border-zinc-700">AI Assistant</span>
      </div>
          ...
          {activeTab === 'search' ? (
            <div className="flex-1 flex flex-col p-6 max-w-4xl mx-auto w-full">
              <div className="mb-8 text-center">
                ...
                <p className="text-zinc-400">Search across documents, tasks, knowledge base, and conversations</p>
              </div>
                            ...
                            >
                              <div className="flex items-start justify-between mb-2">
                                <div className="flex items-center gap-2">
                                  ...
                                  {match.type === 'knowledge_base' && <BookOpen className="w-4 h-4 text-amber-400" />}
                ...
                <div className="space-y-6 max-w-3xl mx-auto pb-10">
                  ...
                  {messages.length === 0 && (
                    <motion.div 
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="mb-8 p-8 rounded-2xl bg-gradient-to-br from-indigo-900/20 via-purple-900/20 to-zinc-900 border border-indigo-500/20 text-center"
                    >
                      <Sparkles className="w-12 h-12 text-pink-500 mx-auto mb-4" />
                      <h3 className="text-xl font-semibold text-white mb-2">Welcome to Jarvis</h3>
                      <p className="text-zinc-400 text-sm mb-6 max-w-md mx-auto">
                        I can help you draft reports, analyze tasks, search your documents, and manage your projects. 
                        I have access to your tasks, documents, and knowledge base.
                      </p>
        ...
        <div className="w-72 border-l border-zinc-800 bg-zinc-900 p-6 hidden xl:block">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 rounded-lg bg-zinc-800/50 border border-zinc-800">
              ...
              <p className="text-xs text-zinc-400">
                I can search and answer from your knowledge base files.
              </p>
            </div>
